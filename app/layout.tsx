  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          // 1. FIX: Spread formData FIRST to avoid TypeScript overwrite errors
          ...formData,
          
          // 2. Add your specific keys and overrides below it
          access_key: "YOUR_WEB3FORMS_ACCESS_KEY", 
          from_name: formData.name,
          
          // 3. This custom subject safely overwrites the default one from formData
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        ">
          ...
          <div className="
            w-full lg:w-2/5 bg-brand-primary text-white p-8 md:p-12 
          ...
          ">
            ...
            <div>
              <h2 className="
                ...
                tracking-tight mb-6 leading-tight break-words
              ">
                Let's Discuss <br/>
                <span className="text-brand-accent">Your Project</span>
              </h2>
              <p className="text-gray-300 font-light leading-relaxed mb-12 break-words text-left">
                ...
                <div className="flex items-start group">
                  ...
                  <div className="ml-5">
                    ...
                    <a 
                      ...
                      className="
                        text-base lg:text-lg font-medium hover:text-brand-accent 
                        transition-colors break-all
                      "
                    >
                      palladiumglobalresources<br className="hidden sm:block lg:hidden"/>@gmail.com
                    </a>
                  </div>
                </div>
          ...
          <div className="w-full lg:w-3/5 p-8 md:p-12 bg-white flex flex-col justify-center">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col space-y-6">
                ...
                <div className="flex-1">
                  <label 
                    ...
                    className="
                      ...
                      uppercase tracking-wider mb-2 break-words
                    "
                  >
                    Full Name
                  </label>
              ...
              {submitStatus === 'success' && (
                <div className="p-4 bg-green-50 text-green-800 border-l-4 border-green-500 text-sm font-medium break-words">
                  Thank you! Your inquiry has been sent to our team successfully.
                </div>
              )}
              {submitStatus === 'error' && (
                <div className="p-4 bg-red-50 text-red-800 border-l-4 border-red-500 text-sm font-medium break-words">
              ...
              <button 
                ...
                className="
                  w-full md:w-auto self-start px-10 py-4 bg-brand-primary text-white 
